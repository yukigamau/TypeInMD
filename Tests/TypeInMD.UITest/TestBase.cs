...
namespace TypeInMD.UITest
{
    public class TestBase
    {
        ...
        private static string GetTopLevelWindowHandle()
        {
            ...
            var TypeInMDWindow = desktopSession.FindElementByClassName("TypeInMD.Windows.FrameWindow");
            var TypeInMDWindowHandle = TypeInMDWindow.GetAttribute("NativeWindowHandle");
            return int.Parse(TypeInMDWindowHandle).ToString("x");
        }
    }
}
